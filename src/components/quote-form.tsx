  ...
  return (
    <form onSubmit={onSubmit} className="rounded-[32px] border border-white/10 bg-white/5 p-6">
      ...
      <div className="grid gap-4 md:grid-cols-2">
        <input name="customerName" placeholder="Seu nome" className="rounded-2xl border border-white/10 bg-black/20 px-4 py-3 text-white outline-none" required />
        ...
        <textarea name="notes" placeholder="Detalhes extras, personalização, tamanho, urgência... se quiser humano, diga aqui também." rows={4} className="rounded-2xl border border-white/10 bg-black/20 px-4 py-3 text-white outline-none md:col-span-2" />
      </div>
