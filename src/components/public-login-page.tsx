      ...
      <div className="mt-10 grid gap-6 xl:grid-cols-[1.05fr_0.95fr]">
        <div className="premium-panel rounded-[32px] p-6">
          <div className="flex flex-wrap items-center justify-between gap-3">
            ...
            <div className="premium-card inline-flex rounded-full bg-black/20 p-1">
              {([
                ...
                <button
                  ...
                  className={`premium-btn h-auto px-4 py-2 text-sm ${
                    mode === item.id
                      ? "premium-btn-primary"
                      : "premium-btn-ghost text-white/68 hover:text-white"
                  }`}
                >
                  {item.label}
                </button>
          ...
          {loggedOut ? (
            <p className="premium-card mt-5 rounded-[22px] border-emerald-300/20 bg-emerald-300/10 px-4 py-3 text-sm text-emerald-100/90">
          ...
          <form onSubmit={onSubmit} className="mt-6 space-y-4">
            ...
            <div className="premium-card rounded-[24px] bg-black/20 px-4 py-3 text-xs leading-6 text-white/48">
            ...
            <button
              ...
              className="premium-btn premium-btn-primary w-full px-6 py-3 disabled:opacity-60"
            >
              {status === "loading"
                ? mode === "register"
                  ? "Criando conta..."
          ...
          <div className="premium-card mt-6 rounded-[28px] bg-black/20 p-5">
            ...
            <button
              type="button"
              disabled
              className="premium-btn premium-btn-secondary mt-4 px-4 py-2 text-sm text-white/45"
            >
        ...
        <div className="premium-panel rounded-[32px] p-6">
          ...
          <div className="mt-6 grid gap-3">
            {[
              ...
              <div key={item.title} className="premium-card rounded-[24px] bg-black/20 p-4">
          ...
          <div className="mt-6 space-y-4">
            <a
              href={whatsappHref}
              className="premium-card premium-card-hover flex items-center justify-between rounded-[24px] border-emerald-400/20 bg-emerald-400/10 px-5 py-4 text-white"
            >
              <div>
            ...
            <Link
              href="/catalogo"
              className="premium-card premium-card-hover flex items-center justify-between rounded-[24px] bg-black/20 px-5 py-4 text-white"
            >
              <div>
          ...
          <div className="premium-card mt-6 rounded-[24px] bg-black/20 p-5 text-sm leading-7 text-white/60">
