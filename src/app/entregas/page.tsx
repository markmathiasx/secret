...
import {
  ...
  getShippingPolicyStructuredData,
  getSiteUrl
} from "@/lib/seo";
...
export const metadata: Metadata = buildPageMetadata({
  ...
  description:
    "Consulte prazo, frete local no Rio de Janeiro e orientacoes de envio da MDH 3D antes de finalizar seu pedido.",
  path: "/entregas"
});

export default function Page() {
  const shippingLd = getShippingPolicyStructuredData();
  const breadcrumbLd = getBreadcrumbStructuredData([
    { name: "Inicio", item: getSiteUrl() },
    { name: "Entregas", item: `${getSiteUrl()}/entregas` }
  ]);

  return (
    <section className="mx-auto max-w-6xl px-6 py-16">
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(shippingLd) }} />
      ...
      <p className="mt-4 max-w-3xl text-base leading-8 text-white/72">
        Entrega local no Rio de Janeiro com estimativa por CEP, prazo claro e orientacao simples para voce comprar com mais confianca.
=======
