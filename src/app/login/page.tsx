...
const benefits = [
  "Salvar favoritos e colecoes preferidas",
  "Acompanhar solicitacoes de orcamento",
  "Consultar historico de pedidos",
  "Receber uma experiencia mais pessoal"
] as const;
...
export default function LoginPage() {
  ...
  async function oauthGoogle() {
    ...
    if (!supabaseBrowser) {
      setError("Login social indisponivel no momento. Voce ainda pode navegar como visitante e fechar pelo WhatsApp.");
      return;
    }
    ...
    <section className="mx-auto max-w-5xl px-6 py-20">
      <div className="rounded-[36px] border border-white/10 bg-white/5 p-8 md:p-10">
        ...
        <p className="mt-4 max-w-2xl text-white/70">
          A navegacao publica continua aberta, mas a conta libera favoritos sincronizados, historico e um topo mais pessoal.
        </p>
