...
export const envSchema = z.object({
  ...
  EMAIL_PROVIDER: z.enum(["resend", "sendgrid", "mailgun", "smtp"]).optional(),
  ...
  NEXT_PUBLIC_GTM_ID: optionalTrimmedString,
  VITE_GTM_ID: optionalTrimmedString,
  VITE_META_PIXEL_ID: optionalTrimmedString,
  ...
  NEXT_PUBLIC_NUVEMSHOP_BASE_URL: optionalUrl,
  NUVEMSHOP_BASE_URL: optionalUrl,
