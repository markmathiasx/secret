...
export type Product = {
  ...
  readyToShip?: boolean;
  realPhoto?: boolean;
  visualKind?: "real_photo" | "concept_image";
...
function createProduct(seed: CatalogSeed): Product {
  ...
  const visualKind = seed.visualKind ?? (seed.id.startsWith("real-") ? "real_photo" : "concept_image");
  const realPhoto = seed.realPhoto ?? visualKind === "real_photo";
  const defaultCollection = visualKind === "real_photo" ? "Fotos reais" : "Imagens conceituais";
  const defaultTags = ["a1 mini", visualKind === "real_photo" ? "foto real" : "imagem conceitual", "marketplace"];
  ...
  return {
    ...
    collection: seed.collection ?? defaultCollection,
    colors,
    grams,
    hours,
    complexity,
...
const baseCatalog: Product[] = [
  ...
  createProduct({
    ...
    description: "Suporte dobravel impresso em 3D para oculos, com berco inclinado para apoiar a armacao sem pressionar as lentes e manter a mesa organizada.",
    pricePix: 32.9,
    category: "Accessories",
    subcategory: "Organizacao pessoal",
    collection: "Projetos para vender",
    tags: ["oculos", "glasses stand", "suporte mesa", "organizacao"],
    imageHint: "3d printed foldable eyeglasses stand",
    technical: {
      typeProduct: "accessory",
      componentScope: "acessorios",
  ...
  createProduct({
    ...
    description: "Suporte de mesa impresso em 3D para controle Xbox Series / One e gamepads de formato similar, com berco curvo para apoiar o controle sem tombar e liberar a bancada.",
    pricePix: 39.9,
    category: "Accessories",
    subcategory: "Setup gamer",
    collection: "Projetos para vender",
    tags: ["controle xbox", "gamepad stand", "suporte mesa", "setup gamer"],
    imageHint: "3d printed xbox controller desk stand",
    technical: {
      typeProduct: "accessory",
      componentScope: "acessorios",
      partNumber: "MW-GAMEPAD-STAND",
      symptomTags: ["controle solto", "controle xbox", "organizacao da mesa"],
    },
  }),
  createProduct({
    id: "proj-105",
  ...
  createProduct({
    ...
    description: "Organizador de cabos impresso em 3D do tipo trilho e clip, pensado para guiar fios de carregamento, monitor e perifericos sem deixar a mesa embolada.",
    pricePix: 24.9,
    category: "Accessories",
    subcategory: "Gerenciamento de cabos",
    collection: "Projetos para vender",
    tags: ["cable organizer", "trilho cabos", "setup limpo", "mesa"],
    imageHint: "3d printed cable organizer rail",
    technical: {
      typeProduct: "accessory",
      componentScope: "acessorios",
  ...
  createProduct({
    ...
    description: "Suporte de celular impresso em 3D com visual de exoesqueleto, pensado para apoiar o telefone em angulo de mesa para videochamada, leitura ou bancada.",
    pricePix: 44.9,
    category: "Accessories",
    subcategory: "Suportes para celular",
    collection: "Projetos para vender",
    tags: ["suporte celular", "exoskeleton", "mesa", "live"],
    imageHint: "3d printed exoskeleton phone stand",
    technical: {
      typeProduct: "accessory",
      componentScope: "acessorios",
  ...
  createProduct({
    ...
    description: "Suporte vertical impresso em 3D para relogio e smartwatch, com apoio estavel para deixar pulseira, caixa e base de carga organizadas na mesa.",
    pricePix: 28.9,
    category: "Accessories",
    subcategory: "Organizacao pessoal",
    collection: "Projetos para vender",
    tags: ["smartwatch", "relogio", "suporte", "organizador"],
    imageHint: "3d printed watch and smartwatch stand",
    technical: {
      typeProduct: "accessory",
      componentScope: "acessorios",
...
const geekCatalogSeeds: CatalogSeed[] = [
  {
    ...
    imageSrc: "/products/geek/cavaleiro-medieval-mini/cavaleiro-medieval-mini-original.png",
    gallery: ["/products/geek/cavaleiro-medieval-mini/cavaleiro-medieval-mini.png"],
  ...
  },
  {
    ...
    description: "Coruja articulada em miniatura com corpo arredondado, olhos grandes e segmentos moveis, pensada para decoracao de bancada e presentes criativos.",
    pricePix: 54.9,
    category: "Accessories",
    subcategory: "Criaturas e mascotes",
    collection: "Geek imagem conceitual",
    theme: "nature",
    tags: ["coruja", "articulado", "criatura", "colecionavel"],
    imageHint: "3d printed articulated owl collectible figurine",
    visualKind: "concept_image",
    technical: { typeProduct: "accessory", componentScope: "acessorios" },
  },
  {
    id: "geek-003",
    ...
    description: "Dragao europeu mini com asas abertas, corpo robusto e base redonda, seguindo a linguagem de miniatura fantasy impressa em 3D para vitrine geek.",
    pricePix: 79.9,
    category: "Accessories",
    subcategory: "Criaturas e mascotes",
    collection: "Geek imagem conceitual",
    ...
    imageHint: "3d printed european dragon mini figurine with open wings",
    visualKind: "concept_image",
    technical: { typeProduct: "accessory", componentScope: "acessorios" },
  },
  {
    ...
    description: "Dragao oriental articulado de corpo longo e segmentado, com leitura de serpente asiatica impressa em 3D para colecionadores e setups personalizados.",
    pricePix: 99.9,
    category: "Accessories",
    subcategory: "Criaturas e mascotes",
    collection: "Geek imagem conceitual",
    ...
    imageHint: "3d printed articulated oriental dragon collectible",
    visualKind: "concept_image",
    technical: { typeProduct: "accessory", componentScope: "acessorios" },
  },
  {
    ...
    imageSrc: "/products/geek/elsa-frozen-chibi/elsa-frozen-chibi-original.png",
    gallery: ["/products/geek/elsa-frozen-chibi/elsa-frozen-chibi.png"],
    description: "Figura chibi inspirada em princesa gelada, com foto real da peça impressa e imagem complementar tratada para o anuncio.",
    pricePix: 74.9,
    category: "Accessories",
  ...
  },
  {
    ...
    imageSrc: "/products/geek/foguete-espacial-mini/foguete-espacial-mini-original.png",
    gallery: ["/products/geek/foguete-espacial-mini/foguete-espacial-mini.png"],
    description: "Mini foguete espacial com foto real da peça impressa e imagem complementar de vitrine para a linha sci-fi.",
    pricePix: 69.9,
    category: "Accessories",
    subcategory: "Decoracao geek",
    collection: "Geek foto real",
  ...
  },
  {
    ...
    imageSrc: "/products/geek/goku-dragon-ball-chibi/goku-dragon-ball-chibi-original.png",
    gallery: ["/products/geek/goku-dragon-ball-chibi/goku-dragon-ball-chibi.png"],
    description: "Personagem chibi inspirado em lutador anime, com foto real da peça impressa e imagem complementar de vitrine.",
    pricePix: 84.9,
    category: "Accessories",
    subcategory: "Anime e game chibi",
    collection: "Geek foto real",
  ...
  },
  {
    ...
    imageSrc: "/products/geek/kirby-nintendo-chibi/kirby-nintendo-chibi-original.png",
    gallery: ["/products/geek/kirby-nintendo-chibi/kirby-nintendo-chibi.png"],
    description: "Miniatura chibi inspirada em personagem classico Nintendo, com foto real da peça impressa e imagem complementar de vitrine.",
    pricePix: 64.9,
    category: "Accessories",
    subcategory: "Anime e game chibi",
    collection: "Geek foto real",
  ...
  },
  {
    ...
    imageSrc: "/products/geek/luffy-one-piece-chibi/luffy-one-piece-chibi-original.png",
    gallery: ["/products/geek/luffy-one-piece-chibi/luffy-one-piece-chibi.png"],
    description: "Figura chibi inspirada em pirata anime, com foto real da peça impressa e imagem complementar de vitrine.",
    pricePix: 89.9,
    category: "Accessories",
    subcategory: "Anime e game chibi",
    collection: "Geek foto real",
  ...
  },
  {
    ...
    imageSrc: "/products/geek/mario-nintendo-chibi/mario-nintendo-chibi-original.png",
    gallery: ["/products/geek/mario-nintendo-chibi/mario-nintendo-chibi.png"],
    description: "Mario em estilo chibi com foto real da peça impressa e imagem complementar de vitrine gamer.",
    pricePix: 79.9,
    category: "Accessories",
    subcategory: "Anime e game chibi",
    collection: "Geek foto real",
  ...
  },
  {
    ...
    imageSrc: "/products/geek/pikachu-pokemon-chibi/pikachu-pokemon-chibi-original.png",
    gallery: ["/products/geek/pikachu-pokemon-chibi/pikachu-pokemon-chibi.png"],
    description: "Pikachu em estilo chibi com foto real da peça impressa e imagem complementar de vitrine para anuncio.",
    pricePix: 84.9,
    category: "Accessories",
    subcategory: "Anime e game chibi",
    collection: "Geek foto real",
  ...
  },
  {
    ...
    imageSrc: "/products/geek/polvo-oceano-articulado/polvo-oceano-articulado-original.png",
    gallery: ["/products/geek/polvo-oceano-articulado/polvo-oceano-articulado.png"],
    description: "Polvo articulado com foto real do lote impresso e imagem complementar de vitrine para kits de mesa e presente.",
    pricePix: 59.9,
    category: "Accessories",
    subcategory: "Criaturas e mascotes",
    collection: "Geek foto real",
  ...
  },
  {
    ...
    description: "Sasuke em estilo chibi com cabelo preto espetado, faixa ninja e espada nas costas, seguindo a leitura de miniatura anime premium sob encomenda.",
    pricePix: 92.9,
    category: "Accessories",
    subcategory: "Anime e game chibi",
    collection: "Geek imagem conceitual",
    ...
    imageHint: "3d printed sasuke chibi figurine with ninja headband and sword",
    visualKind: "concept_image",
    technical: { typeProduct: "accessory", componentScope: "acessorios" },
  },
  {
    ...
    imageSrc: "/products/geek/sonic-hedgehog-chibi/sonic-hedgehog-chibi-original.png",
    gallery: ["/products/geek/sonic-hedgehog-chibi/sonic-hedgehog-chibi.png"],
    description: "Sonic chibi com foto real da peça impressa e imagem complementar de vitrine para colecao gamer.",
    pricePix: 79.9,
    category: "Accessories",
    subcategory: "Anime e game chibi",
    collection: "Geek foto real",
  ...
  },
  {
    ...
    imageSrc: "/products/geek/totoro-my-neighbor-chibi/totoro-my-neighbor-chibi-original.png",
    gallery: ["/products/geek/totoro-my-neighbor-chibi/totoro-my-neighbor-chibi.png"],
    description: "Totoro estilo chibi com foto real da peça impressa e imagem complementar de vitrine para linha geek presenteavel.",
    pricePix: 76.9,
    category: "Accessories",
    subcategory: "Anime e game chibi",
    collection: "Geek foto real",
  ...
  },
  {
    ...
    description: "Mini tubarao de oceano com corpo compacto, olhos grandes e leitura amigavel de mascote marinho para decoracao de bancada e kits criativos.",
    pricePix: 49.9,
    category: "Accessories",
    subcategory: "Criaturas e mascotes",
    collection: "Geek imagem conceitual",
    ...
    imageHint: "3d printed shark mini mascot figurine",
    visualKind: "concept_image",
    technical: { typeProduct: "accessory", componentScope: "acessorios" },
  },
];
