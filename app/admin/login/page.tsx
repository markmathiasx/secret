  ...
  return (
    <section className="mx-auto max-w-lg px-6 py-20">
      ...
      <p className="mt-4 text-white/65">
        {hasStoredAdmin ? "Credenciais do painel protegidas com sessão assinada." : "Em produção o painel usa credencial segura do ambiente; localmente ainda pode usar o cofre do projeto."}
      </p>
