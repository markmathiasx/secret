...
function buildClientAssistantFallback(message: string, cardCheckoutReady: boolean) {
  ...
  if (/(site|loja|mdh|cat[aá]logo|checkout|conta|login|como funciona|p[aá]gina)/.test(normalized)) {
    return cardCheckoutReady
      ? "Posso responder sobre o catálogo, páginas do site, checkout, Pix, cartão online, entrega, personalização, STL e atendimento humano. Pergunte como no ChatGPT: produto, prazo, preço, mídia validada, pedido ou suporte."
      : "Posso responder sobre o catálogo, páginas do site, checkout, Pix, entrega, personalização, STL e atendimento humano. Pergunte como no ChatGPT: produto, prazo, preço, mídia validada, pedido ou suporte.";
  }
  ...
  if (/(presente|mídia validada|lembranc|gift)/.test(normalized)) {
  ...
  return `Posso te orientar por objetivo, faixa de preço, mídia validada, pronta entrega ou personalização. Se preferir atendimento humano imediato, use https://wa.me/${whatsappNumber}.`;
}
  ...
  return {
    ...
    content: aiAssistantReady
      ? [
          ...
          "Posso separar produtos por faixa de preço, mídia validada, pronta entrega, setup, presente ou personalização.",
          cardCheckoutReady
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-white/50">
                    Converse sobre produtos, páginas do site, dia/hora, pagamento, entrega, mídia validada, pronta entrega ou personalização.
                  </p>
                </div>
              </div>
            </div>
